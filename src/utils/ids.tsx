...
export const SWAP_PROGRAM_OWNER_FEE_ADDRESS = new PublicKey('4rdog8sEF6BJadd8L2zWgfNKaFK6gHE7tT8iGo1dQANc')
...
export const PROGRAM_IDS = [
  {
    ...
    swap: () => ({
      current: {
        pubkey: new PublicKey('4rdog8sEF6BJadd8L2zWgfNKaFK6gHE7tT8iGo1dQANc'),
        pubkeys: [
          new PublicKey('4rdog8sEF6BJadd8L2zWgfNKaFK6gHE7tT8iGo1dQANc'),
